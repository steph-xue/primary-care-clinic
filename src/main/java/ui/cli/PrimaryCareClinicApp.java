...
// A class representing the command-line interface for the primary care clinic application.
public class PrimaryCareClinicApp {
    ...
    // MODIFIES: this
    // EFFECTS: Adds new patient to patient record list using input from the user for first name, last name,
    ...
    // EFFECTS: Adds additional information for the new the patient including allergies, medications,
    ...
    // EFFECTS: Views all current patient records and handles the view all patients menu.
    ...
    // EFFECTS: Views all clinical notes for selected patient and handles the view all 
    ...
    // MODIFIES: this
    // EFFECTS: Renames the clinic using input from the user and prints out a success message.
    ...
    // EFFECTS: Prints a welcome message for the current clinic.
